<template>
  <div class="container" style="background-image:url(img136.jpg);background-repeat:no-repeat;background-size:100%;">
    <div class="loginBox">
      <a-form-model ref="loginFormRef" :rules="rules" :model="formdata" class="loginForm">
        <a-form-model-item prop="username">
          <a-input v-model="formdata.username" placeholder="请输入用户名(邮箱)">
...
export default {
  data() {
    return {
      ...
      rules: {
        username: [
          { required: true, type: 'email', message: '请输入用户名（邮箱）', trigger: 'blur' },
        ],
        password: [
