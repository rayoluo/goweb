    ...
    <a-form-model labelAlign="left" :label-col="{ span: 2 }" :wrapper-col="{ span: 12 }">
      ...
      <a-form-model-item label="头像">
        <a-upload listType="picture" name="file" :action="upUrl" :headers="headers" @change="avatarChange">
          <a-button style="margin-right: 10px"> <a-icon type="upload" />点击上传 </a-button>
      ...
      <a-form-model-item label="关于">
        <!-- <Editor v-model="artInfo.content"></Editor> -->
        <mavon-editor ref="md" v-model="profileInfo.aboutInfo" style="height: calc(100vh - 200px);width:150%" @imgAdd="mdUploadImg">
        </mavon-editor>
      </a-form-model-item>
