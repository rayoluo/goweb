  ...
  <div>
    ...
    <div class="home-banner">
      <div class="banner-container">
        <!-- 联系方式 -->
        <h1 class="blog-title animated zoomIn">雨落的个人博客</h1>
        <!-- 一言 -->
        ...
        <div class="blog-wrapper">
          <v-card class="animated zoomIn blog-card mt-5">
            ...
            <div class="card-info-social">
              <a
                target="_blank"
                href="https://weibo.com/u/5674548242"
                class="iconfont iconweibo myIconFont"
              />
              <a
                target="_blank"
                href="https://github.com/Rayoluo"
                class="ml-5 mr-5 iconfont icongithub myIconFont"
              />
              <a
                target="_blank"
                href="https://blog.csdn.net/hbhgyu"
                class="iconfont icon-csdn myIconFont"
              />
            </div>
          </v-card>
          <!-- 网站信息
...
export default {
  ...
  methods: {
    ...
    runTime() {
      var timeold = new Date().getTime() - new Date("May 7,2021").getTime();
    ...
    // 获取所有文章信息，用于实现文章详情上一篇下一篇以及最新文章功能
    async getAllArts() {
      const { data: res } = await this.axios.get(`article/all`);
      // console.log("打印所有文章信息")
      // console.log(res)
      this.$store.commit("storeAllArts", res.data);
    },
    getBlogInfo() {
      ...
      this.axios
        ...
        .then(({ data }) => {
          ...
          if (data.data.length) {
            ...
            // console.log(this.articleList[0].content)
...
.home-banner {
  ...
  right: 0;
  height: 100vh;
  background: url(../../assets/img/home.jpg) center
